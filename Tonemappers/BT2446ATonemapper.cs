...
public struct BT2446ATonemapper(float sdrNits = 100f, float targetNits = 1000f) : IToneMapper
{
    ...
    /// </summary>
    /// <inheritdoc/>
    public readonly Vector3 PerformTonemap(in Vector3 col, in float exposure) => throw new NotImplementedException("Not implemented yet!!");
    ...
    /// <returns></returns>
    public readonly Vector3 PerformInverse(
        in Vector3 color,
        in float exposure)
    {   
        ...
        // NOTE: I tried to get the fast path working, but I appear to have screwed up somewhere. The 'slow path' is fast enough for this purpose.
